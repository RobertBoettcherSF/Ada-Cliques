--  Cliques body — graph API, Bron–Kerbosch pivoting, colouring-bound BnB.

pragma Ada_2022;

with Interfaces; use Interfaces;

package body Cliques
  with SPARK_Mode => Off
is
   ...
   -------------------------------------------------------------------------
   -- Colouring-bound branch-and-bound (educational MaxCliqueDyn spirit)
   -------------------------------------------------------------------------
   ...
   function Clique_Number (G : Graph) return Natural is
      Clique : Vertex_Set;
      Size   : Natural;
   begin
